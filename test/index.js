...
Promise.all([
	...
	`),
	new CSSStyleSheet({ media: '(max-width: 800px)'}).replace(`
		body {
	...
	document.body.innerHTML = `
		...
		<nav id="nav">
			...
			<button type="button" popovertarget="htmlForm" popovertargeaction="show">Test Sanitizer &amp; Policy</button>
		</nav>
		<main id="main">
		...
		<form id="htmlForm" popover="manual">
			<fieldset>
			...
			<div>
				...
				<button type="reset" popovertarget="htmlForm" popovertargetactin="hide">Cancel</button>
			</div>
		</form>
	`;
	...
	document.forms.htmlForm.addEventListener('submit', event => {
